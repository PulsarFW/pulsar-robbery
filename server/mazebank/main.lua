...
function MazeBankDisablePower(source)
	...
	exports['pulsar-robbery']:TriggerPDAlert(source, vector3(-1332.651, -846.451, 17.080), "10-33",
...
AddEventHandler("Robbery:Server:Setup", function()
	...
	exports["pulsar-chat"]:RegisterAdminCommand("resetmb", function(source, args, rawCommand)
		ResetMazeBank()
	end, {
		help = "Force Reset Maze Bank Heist",
	}, 0)

	exports["pulsar-core"]:RegisterServerCallback("Robbery:MazeBank:SecureBank", function(source, data, cb)
	...
	exports["pulsar-core"]:RegisterServerCallback("Robbery:MazeBank:ElectricBox:Hack", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			if
				(
	...
	exports["pulsar-core"]:RegisterServerCallback("Robbery:MazeBank:ElectricBox:Thermite", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			if
				(
	...
	exports["pulsar-core"]:RegisterServerCallback("Robbery:MazeBank:Drill", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			if
				(
	...
	exports["pulsar-core"]:RegisterServerCallback("Robbery:MazeBank:PC:Hack", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			if
				(
				...
				if not _mbInUse.officePcs[data.id] then
					...
					if exports.ox_inventory:ItemsHas(char:GetData("SID"), "adv_electronics_kit", 1) then
						...
						if itemData ~= nil then
							...
							exports["pulsar-core"]:ClientCallback(source, "Robbery:Games:Progress", {
								config = {
